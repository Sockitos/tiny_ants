...
<section id="mint">
    <div class="container flex flex-row justify-center max-w-4xl">        
	    <p class="text-3xl text-align: center md:text-3xl font-bold">WARRIORS TINY ANTS MINT!</p>    
    </div>
